  ...
  return (
    <div className="min-h-screen bg-atlas-black flex items-center justify-center">
      <div className="bg-atlas-gray p-8 rounded-lg shadow-lg w-full max-w-md">
        <h2 className="text-3xl font-bold text-center text-atlas-orange mb-6">Student Login</h2>
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="text-sm font-bold text-gray-300 block mb-2">Email or Institute Code</label>
            <input
              type="email"
              value={email}
         ...
         <p className="text-center text-gray-400 mt-4 text-sm">
            Institute? <Link to="/login/institute" className="text-atlas-orange hover:underline">Login here</Link>
        </p>
