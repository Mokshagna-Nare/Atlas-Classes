        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <StatCard 
                  ...
                  label="Latest Rank"
                  value={latestResult.rank.toString()}
                  subtext="in Physics - Mechanics"
                />
                <StatCard 
                  icon={<CreditCardIcon className="h-6 w-6 text-atlas-orange"/>}
                  label="Latest Grade"
                  value={latestResult.grade}
                  subtext={`${latestResult.score}/${latestResult.maxScore} Points`}
                  valueClass={getGradeColor(latestResult.score)}
                />
            </div>
